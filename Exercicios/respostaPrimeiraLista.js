...
function baseExpoente (base, expoente) {
    console.log("O resultado é: ", Math.pow(base,expoente))
}
//baseExpoente(3,5)
...
function divisao (dividendo, divisor) {
    console.log(`O dividendo é ${dividendo} e o divisor é ${divisor}`)
 ...
 * uma função JavaScript para que ela receba um valor como 0.30000000000000004 e 
 * retorne R$0,30 (observe a vírgula e o ponto).
 */


function corrigeValor (valor) {
    valor.toNumber().replace(".",",")
    valor = Math.floor(valor)
    console.log(`O valor correto é R$${valor}`)
}
corrigeValor(0.30000000000000004)
